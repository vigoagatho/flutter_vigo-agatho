                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                              ...
                                              builder: (context){
                                                return AlertDialog(
                                                  content: Container(
                                                    height: 300,
                                                    width: 200,
                                                    child: Image.network(_image[index].imPath, height: 150, width: 100, fit: BoxFit.cover,)
                                                  ),
                                                );
                                              }),
                                            child: Ink.image(
                                    ...
                                    Container(padding: EdgeInsets.all(8.0), child: Text('Name :', style: TextStyle(fontSize: 15),),),
                                    Container(padding: EdgeInsets.all(8.0), child: Text(_image[index].name, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),),
                                    Container(padding: EdgeInsets.all(8.0), child: Text('Birth date :', style: TextStyle(fontSize: 15),),),
                                    Container(padding: EdgeInsets.all(8.0), child: Text(_image[index].bDate, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),),
                                    Container(padding: EdgeInsets.all(8.0), child: Text('Group name :', style: TextStyle(fontSize: 15),),),
                                    Container(padding: EdgeInsets.all(8.0), child: Text(_image[index].gBand, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),),
